...
interface UtilizationTrackerProps {
  timers: Timer[];
  refreshTrigger: number;
}

export const UtilizationTracker = ({ timers, refreshTrigger }: UtilizationTrackerProps) => {
      ...
      <CardContent className="space-y-4">
        ...
        {selectedTimers.length > 0 && (
          <>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="target-daily" className="text-sm">
                  Daily Target (hours)
                </Label>
                <Input
                  id="target-daily"
              ...
              <div>
                <Label htmlFor="target-weekly" className="text-sm">
                  Weekly Target (hours)
                </Label>
                <Input
                  id="target-weekly"
        ...
        {selectedTimers.length === 0 && (
          <div className="text-center py-6 text-sm text-muted-foreground">
            Select timers above to track your utilization rate
          </div>
        )}
      </CardContent>
    </Card>
